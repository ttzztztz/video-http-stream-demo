...
export var translateLegacyCodec = function translateLegacyCodec(codec) {
  ...
  return codec.replace(
    /avc1\.(\d+)\.(\d+)/i,
    function (orig, profile, avcLevel) {
...
export var codecsFromDefault = function codecsFromDefault(
  master,
  audioGroupId
) {
